...
Config.Core = GetConvar('Core', 'qbr-core') -- in case you rename your qbr-core folder
Config.Menu = GetConvar('Menu', 'qbr-menu') -- in case you rename your qbr-menu folder
Config.UseTarget = false -- not yet available
